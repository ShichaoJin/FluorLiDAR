...
Here, we provide an exe file for simulating PAR from LiDAR data. The detailed operation process is provided in a readme.txt in the _PAR_exe_share_ directory.
